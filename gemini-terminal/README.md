...
![Gemini Terminal Screenshot](https://github.com/inzone1941-afk/gemini-cli-home-assistant-addons/raw/main/gemini-terminal/screenshot.png)
...
- **Persistent Package Management**: Install APT and pip packages that survive container restarts using the configuration options.
...
# To install packages that persist across restarts, add them to the 
# 'persistent_apt_packages' or 'persistent_pip_packages' list in the 
...
| `persistent_apt_packages` | `[]` | List of APT packages to install on startup. |
