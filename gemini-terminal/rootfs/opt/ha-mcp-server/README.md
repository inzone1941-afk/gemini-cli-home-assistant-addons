...
A comprehensive Model Context Protocol (MCP) server implementing the latest MCP specification (2025-06-18) for deep integration between Gemini Terminal and Home Assistant.
...
Add to your Gemini config (`~/.config/gemini/settings.json`):
